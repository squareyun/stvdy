<template>
  <div id="main-container">
    ...
    <div
      ...
      v-if="!session">
      <div id="img-div">
        <!-- <img src="resources/images/openvidu_grey_bg_transp_cropped.png" alt="오픈비두 로고 이미지임"> -->
        <!-- 이미지부분 -->
      </div>
      <div id="join-dialog">
...
const APPLICATION_SERVER_URL =
  process.env.NODE_ENV === 'production' ? '' : 'http://54.180.9.43:8080/'
...
async function getToken(mySessionId) {
  const response = await axios.post(
    APPLICATION_SERVER_URL + 'rooms/add',
    {
      ...
      password: '1234',
      iamgePath: 'imgURL',
      rule: 'rule Text which is veruy long',
    },
    {
